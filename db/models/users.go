...
var (
	userAllColumns            = []string{"user_id", "user_name", "password_hash", "email"}
	userColumnsWithoutDefault = []string{"user_name", "password_hash", "email"}
	userColumnsWithDefault    = []string{"user_id"}
	userPrimaryKeyColumns     = []string{"user_id"}
	userGeneratedColumns      = []string{"user_id"}
)
